...
var CustomInputHandlers = {
  ...
  bindChangeInputItems: function bindChangeInputItems() {
    $('.changeInput_items').on('click', function () {
      ...
      if ($this.find('input').length === 0) {
        var handleBlurOrEnter = function handleBlurOrEnter() {
  ...
  bindChangeRadioCarItems: function bindChangeRadioCarItems() {
  ...
  bindChangeRadioPaymentMethodItems: function bindChangeRadioPaymentMethodItems() {
    $('.changeRadioPayMethod_items').on('click', function () {
      var $this = $(this);
      var currentText = $this.text().trim();
      if ($this.find('input[type="radio"]').length === 0) {
        var radioOptions = "\n                    <div class=\"form-check form-check-inline\">\n                        <input class=\"form-check-input\" type=\"radio\" id=\"cash\" value=\"\u73FE\u91D1\" ".concat(currentText === '現金' ? 'checked' : '', ">\n                        <label class=\"form-check-label\" for=\"cash\">\u73FE\u91D1</label>\n                    </div>\n                    <div class=\"form-check form-check-inline\">\n                        <input class=\"form-check-input\" type=\"radio\" id=\"remittance\" value=\"\u532F\u6B3E\" ").concat(currentText === '匯款' ? 'checked' : '', ">\n                        <label class=\"form-check-label\" for=\"remittance\">\u532F\u6B3E</label>\n                    </div>");
        $this.html(radioOptions);
        $this.find('input[type="radio"]').on('change', function () {
          var newText = $(this).val().trim();
          $this.html(newText);
  ...
  bindChangeTextareaLgItems: function bindChangeTextareaLgItems() {
    $('.changeTextarea_lg_items').on('click', function () {
      var $this = $(this);
      var currentText = $this.html().replace(/<br\s*[\/]?>/gi, '\n').trim();
      if ($this.find('textarea').length === 0) {
        var handleBlurOrCtrlEnter = function handleBlurOrCtrlEnter(e) {
  ...
  bindChangeNumber5Items: function bindChangeNumber5Items() {
    $('.changeNumber5_items').on('click', function () {
      var $this = $(this);
      var currentText = $this.text().trim();
      if ($this.find('input').length === 0) {
        var handleBlurOrEnter = function handleBlurOrEnter(e) {
  ...
  bindChangeUniformNumItems: function bindChangeUniformNumItems() {
  ...
  // selectOptionRoom
  bindChangeSelectRoomItems: function bindChangeSelectRoomItems() {
  ...
  bindChangeSelectPaymentPurposeItems: function bindChangeSelectPaymentPurposeItems() {
  ...
  // selectOptionStatus
  bindChangeSelectStatusItems: function bindChangeSelectStatusItems() {
  ...
  bindChangeSelectPurchaseItems: function bindChangeSelectPurchaseItems() {
  ...
  bindChangeDecimalItems: function bindChangeDecimalItems() {
