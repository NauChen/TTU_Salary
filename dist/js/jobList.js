...
var dataset_jobEngineeringList = [{
  "id": "1",
  "createDate": "2024-04-25",
  "company": "綜合工廠有限公司",
  "jobTitle": "資深工程師",
...
$(function () {
  $('#jobAllList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobEngineeringList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobManagementList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobDesignList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobLanguageList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobDetailsModal').on('show.bs.modal', function (event) {
    ...
    var jobId = String(button.data('id'));
    // console.log('Button clicked, jobId:', jobId);

    // console.log('jobId type:', typeof jobId);

    var jobData = dataset_jobList.find(function (job) {
      return job.id === jobId;
    });
    if (jobData) {
