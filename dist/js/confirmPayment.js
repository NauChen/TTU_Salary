  ...
  $('#confirmPaymentCultivationRoomList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
    ...
    // 7
    {
      ...
      render: function render(data, type, row) {
        ...
        var receivedDateFirst = row.receivedDateFirst;
        var receivedDateSecond = row.receivedDateSecond;
        var secondDeadline = row.secondDeadline;
        if (company && (secondDeadline == '' || secondDeadline == null) && receivedDateFirst != '' && receivedDateFirst != null || secondDeadline && receivedDateSecond != '' && receivedDateSecond != null) {
