...
$(function () {
  var table = $('#jobActiveList').DataTable(_objectSpread(_objectSpread({}, commonSettingsTable), {}, {
  ...
  $('#jobDetailsModal').on('show.bs.modal', function (event) {
    ...
    var jobData = dataset_jobActiveListings.find(function (job) {
      return job.id === jobId;
    });
    if (jobData) {
  ...
  $('#deleteTheseJobs').click(function () {
    ...
    table.rows().every(function () {
      var row = this.node();
      var checkbox = $(row).find('.job-checkbox');
