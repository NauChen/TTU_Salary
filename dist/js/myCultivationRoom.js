...
$(function () {
  ...
  dataset_myCultivationRoom.forEach(function (item) {
    ...
    var secondDeadline = new Date(item.secondDeadline);
    var deadLineDiff = secondDeadline.getTime() - today.getTime();
    var deadLineDiffDays = Math.ceil(deadLineDiff / (1000 * 3600 * 24));
  ...
  $('#myRenewContracList').DataTable(_objectSpread(_objectSpread({}, commonSettingsProvision), {}, {
    ...
    // 7
    {
      ...
      render: function render(data, type, row) {
        ...
        var deadLineDiffDays = row.deadLineDiffDays;
        var paymentDateSecond = row.paymentDateSecond;
        if (diffDays === null) {
