...
$(function () {
    ...
    $('#vendorDetailModal').on('show.bs.modal', function (event) {
        ...
        if (firmData.status === "通過" || firmData.status === "不通過") {
            ...
            $('#companyName, #responsiblePerson, #referrer, #contactPerson, #jobTitle,#companyAdd, #locationOfCompany, #tutoringProfessor, #nurtureProgram').removeClass("changeInput_items");
            $('#companyDescription, #helpItems, #adminNote').removeClass("changeTextarea_lg_items");
            ...
            $('#companyName, #responsiblePerson, #referrer, #contactPerson, #jobTitle,#companyAdd, #locationOfCompany, #tutoringProfessor, #nurtureProgram').addClass("changeInput_items");
            $('#companyDescription, #helpItems, #adminNote').addClass("changeTextarea_lg_items");
        ...
        $('#updateBtn').click(function () {
            ...
            formData.append('uniformNum', $('#uniformNum').text());
            formData.append('creationDate', $('#creationDate').text());
            formData.append('capitalAmount', $('#capitalAmount').text());
            formData.append('employeesNum', $('#employeesNum').text());
            formData.append('responsiblePerson', $('#responsiblePerson').text());
            formData.append('referrer', $('#referrer').text());
            formData.append('phoneNum', $('#phoneNum').text());
            formData.append('companyEmail', $('#companyEmail').text());
            formData.append('lineId', $('#lineId').text());
            formData.append('contactPerson', $('#contactPerson').text());
            formData.append('ext', $('#ext').text());
