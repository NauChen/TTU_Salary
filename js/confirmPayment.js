...
$(function () {
        ...
        "columns": [
            {
                ...
                data: 'paymentDateSecond', title: "廠商通知<br>付款日",
    ...
    // 車位與識別證 
    $('#confirmPaymentCarOrCardList').DataTable({
        ...commonSettingsTable,
        ...
        "columns": [
            ...
            { data: 'company', title: "公司名稱", }, // 1
            { data: 'amount', title: "費用", }, // 2
            { data: 'type', title: "類型", }, // 3
            {
                data: 'paymentDate', title: "廠商通知<br>付款日", // 4
                render: function (data, type, row) {
                    const paymentDateFirst = row.paymentDateFirst;
                    if (data === '' || data === null) {
                        return paymentDateFirst;
    ...
    $('#confirmPaymentCultivationRoomList2').DataTable({
        ...commonSettingsTable,
        "data": dataset_confirmPaymentCultivationRoom2,
        "columns": [
            { data: 'room', title: '培育室' }, // 0
            { data: 'amount', title: "費用", }, // 1
            {
                data: 'company', title: "配置公司", // 2
                render: function (data) {
                    if (data === null || data == '') {
                        return '尚未培育';
                    } else {
            ...
            {
                data: 'firstDeadline', title: "第一階段", // 3
                render: function (data, type, row) {
            ...
            {
                data: 'secondDeadline', title: "第二階段", // 4
                render: function (data, type, row) {
            ...
            {
                data: 'paymentDateSecond', title: "廠商通知<br>付款日", // 5
                render: function (data, type, row) {
                    const paymentDateFirst = row.paymentDateFirst;
                    if (data == '' || data == null) {
        ...
        "columnDefs": [
            ...
            { className: "text-nowrap", targets: [0, 1, 3, 4, 5] },
        ],
        createdRow: function (row, data, dataIndex) {
