...
$(function () {
    $('#renewContractAppList').DataTable({
        ...
        "columns": [
            ...
            { data: 'type', title: "續約類型", },
            { data: 'company', title: "申請人公司", },
            { data: 'building', title: "大樓", },
            { data: 'place', title: "位置", },
    ...
    $('#renewContractParkingSpaceModel').on('show.bs.modal', function (event) {
        ...
        let parkingSpaceData = dataset_renewContractApp.find(perkingSpace => perkingSpace.id === psId);
